# Generated by Powerlevel10k configuration wizard on 2026-02-24 at 18:51 UTC.
...
# slanted separators, sharp heads, slanted tails, 1 line, sparse, few icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    my_name                 # custom name segment
    os_icon                 # os identifier
    dir                     # current directory (blue block with full path)
    vcs                     # git status
